...
class firstlist1 extends Frame{
 ...
 public static void main(String args[])
  {
    ...
    TextField t1,t2;
     ...
     t2=new TextField();
     f.add(t1);
     f.add(t2);  //adding textfield to frame
    ...
    TextArea a1;
    a1=new TextArea();
    f.add(a1);     //adding text area to frame
    ...
    List lt1=new List(5);
    f.add(lt1); //adding list to the frame
